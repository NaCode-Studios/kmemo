...
mavenPublishing {
    ...
    coordinates("io.github.nacode-studios", "kmemo-spring-ai", version.toString())
    pom {
        name.set("Kmemo Spring AI advisor")
        description.set(
            "A caching Advisor for Spring AI's ChatClient, backed by Kmemo — the semantic cache for LLM " +
